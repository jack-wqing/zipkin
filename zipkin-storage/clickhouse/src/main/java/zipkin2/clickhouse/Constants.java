...
public class Constants {
  ...
  public static final String SPAN_QUERY_REQUEST_TIME_SQL = "select * from %s where id != '' and time >= ? AND time <= ?";
  public static final String SPAN_QUERY_REQUEST_SQL = "select * from %s where  id != '' and  localEndpointServiceName = ? AND time >= ? AND time <= ?";
